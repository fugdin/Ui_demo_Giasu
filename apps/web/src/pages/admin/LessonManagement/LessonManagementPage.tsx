...
import { lessonsApi, coursesApi } from '@/services/adminApi';
      ...
      >
        ...
        <Space>
          ...
          <Button
            ...
            title="Nội dung"
            onClick={() => navigate(`/admin/courses/${courseId}/lessons/${lesson.id}/content`)}
          />
          <Button
            type="text"
            danger
    ...
    <div>
      ...
      {lessons.length === 0 ? (
        <EmptyState
          ...
          onCtaClick={() => navigate(`/admin/courses/${courseId}/lessons/create`)}
        />
      ) : (
        <DndContext
          sensors={sensors}
